    ...
    <div className={styles.main}>
      ...
      <div className={styles.model1_container}>
        ...
        <div className={styles.knife_container}>
          ...
          >
            ...
            {/* <Model path="/EMB_IRON-DAGGER-KLD-3233.glb"/> */}
            {/* <Model path="/EMB_IRON-KNIFE-AGR-1-67.glb" /> */}
            {/* <Model path="/EMB_IRON-RING-KLD-4-3208.glb"/> */}
            {/* <Model path="/EMB_KDG-1-KNIFE-SL3.glb"/>
            <Model path="/EMB_KDG-3-URN92-SL5.glb"/> */}
            {/* <Model path="/EMB_NAIL-KLD-7-1284.glb"  /> */}
            <Model
            ...
            {/* <Model path="/GRAFFITI-KLD-4-ZB-5-1-185.glb"/>
            <Model path="/kuyahtanar_iron_smelting_furnace_-_part_1.glb"/>
            <Model path="/Obj8.glb"/>
      ...
      <div className={styles.carousel_container}>
        ...
        <div className={styles.carousel_nav}>
          <div className={styles.carousel_nav_items}>
            <h1></h1>
            <p>1876</p>
          </div>
          <div>
        ...
        <div className={styles.carousel_content}>
          <div className={styles.carousel_content_text}>
            <h1>பெர்லின் நகரைச் சார்ந்த எஃப். ஜாகோர் அகழ்வாய்வு</h1>
            <p>
              பொருநை ஆற்றங்கரை நாகரீகத்தில் முதலில் அகழ்வாய்வுக்கு
              உட்படுத்தப்பட்ட இடம் ஆதிச்சநல்லூர் தான். இது பண்டைய பாண்டிய
              மன்னர்களின் துறைமுகமான கொற்கைக்கு மேற்கே 9 கி.மீ தொலைவில்
              அமைந்துள்ளது.
            </p>
          </div>
          <div>
            <img src={Assets.hf} alt="hf image" className={styles.hf} />
          </div>
        </div>
      </div>
      ...
      <div className={styles.beta_container}>
        ...
        <div className={styles.beta_content}>
          <div className={styles.beta_content_text}>
            ...
            <p>
              ஆதிச்சநல்லூரில் கரிம மாதிரிகள் பரிசோதிக்கப்பட்டு கி.மு. 3000
      ...
      <div className={styles.important_findings_container}>
        ...
        <div className={styles.important_findings_text}>
          <div className={styles.important_findings_items}>
            <h2>160</h2>
            <p>முதுமக்கள் தாழிகள் (9 கருப்பு பானைகள், 151 சிவப்பு பானைகள்)</p>
          </div>
          <div className={styles.important_findings_items}>
            <h2>750+</h2>
      ...
      <div className={styles.korkai_footer_content}>
        <img
          src={Assets.korkai_areial}
          alt="korkai areial image"
          className={styles.korkai_areial}
        />
        <img
          src={Assets.korkai_struct}
          alt="korkai structure image"
          className={styles.korkai_struct}
        />
      </div>
      ...
      <div className={styles.footer}>
        ...
        <div>
          <img
            ...
            className={styles.korkai_storage}
          />
        </div>
      </div>
